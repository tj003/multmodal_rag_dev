...
def create_rag_agent(project_id: str, model: str = None):
    """
...
def create_web_search_agent(model: str = None, use_tavily: bool = True):
    """
...
def create_supervisor_tools(project_id: str, model: str = None):
    """
