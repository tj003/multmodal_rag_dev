...
from src.services.awsS3 import S3_BUCKET_NAME as BUCKET_NAME
...
def partition_document(temp_file: str, file_type: str, source_type: str = "file"):
    ...
    dispatch = {
        "pdf": lambda: partition_pdf(
            ...
            infer_table_structure=False,  # Keep tables as structured HTML, not jumbled text.
...
def create_ai_summary(text, tables_html, images_base64):
    ...
    try:
        ...
        response = models["embeddings_llm"].invoke([message])
